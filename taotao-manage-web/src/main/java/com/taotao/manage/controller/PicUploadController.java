...
public class PicUploadController {
    ...
    @ResponseBody
    public String uploadResult(@RequestParam("uploadFile")MultipartFile multipartFile) throws JsonProcessingException {
        //返回结果
        ...
        if (isLegal) {
            ...
            try {
                ...
                String trackerConfig = this.getClass().getClassLoader().getResource("tracker.conf").toString().replaceAll("file:/", "");
                // 设置Tracker server的地址
